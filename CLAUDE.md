# Claude Code instructions — ShortBär Trading OS

Read `docs/PROJECT.md` first. It is the central technical project documentation.

The associated Notion page is the product workspace for ideas, bugs, open requirements, decisions and current product state. The repository/code is the technical truth for what is actually implemented.
