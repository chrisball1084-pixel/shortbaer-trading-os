import { todayIso } from "./market";
import type { AppData, MarketAnalysis } from "./types";

/** Leerer Tag: Grundlage für Seed-Daten und für den automatischen Tageswechsel. */
export function emptyMarket(date: string = todayIso()): MarketAnalysis {
  return {
    date,
    trafficLight: "yellow",
    ...
    leadingEtfs: [], leadingGroups: [], scansChecked: [], researchChecked: [], breakoutQuality: "unclear",
